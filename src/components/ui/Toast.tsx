...
const ToastItem: React.FC<{
  ...
  return (
    <div
      className={`flex items-center p-4 rounded-md border shadow-sm transition-all duration-300 ${
    ...
    >
      ...
      {/* Message */}
      <div className={`ml-3 flex-1 text-sm font-medium ${styles.textColor}`}>
        {toast.message}
      </div>
      ...
      <button
        ...
        className={`ml-3 flex-shrink-0 ${styles.textColor} hover:opacity-70 transition-opacity`}
      >
